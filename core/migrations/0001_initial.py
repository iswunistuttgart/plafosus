# Generated by Django 3.1.1 on 2021-03-11 14:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fixed_price', models.FloatField(default=0, help_text='The fixed costs in € to use the skill.')),
                ...
                ('variable_price', models.FloatField(default=0, help_text='The variable costs in € to use the skill.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fixed_price', models.FloatField(default=0, help_text='The fixed costs in € for this consumable.')),
                ('fixed_co2', models.FloatField(default=0, help_text='The fixed CO2-e for this consumable.')),
                ('variable_price', models.FloatField(default=0, help_text='The variable costs in € for one unit of this consumable.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('constraints', models.ManyToManyField(help_text='Constraints of the specific part process step.', related_name='PartProcessStep', through='core.Constraint', to='core.Requirement')),
        ...
        migrations.AddField(
            ...
            name='part_process_step',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Constraint', to='core.partprocessstep'),
        ),
        migrations.AddField(
            model_name='constraint',
            name='requirement',
