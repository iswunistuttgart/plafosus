    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operator', models.CharField(choices=[('=', '='), ('<', '<'), ('!=', '!='), ('>', '>'), ('>=', '>='), ('<=', '<=')], help_text='Has the result to be equal, smaller, or bigger then this value.', max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(help_text='The unit of the consumable.', max_length=254, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(help_text='The unit of the requirement.', max_length=254)),
                ('category', models.CharField(help_text='The category of the requirement.', max_length=254)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_price', models.PositiveIntegerField(default=0, help_text='The costs in € to use the skill for one unit of theskill specific quantity.', validators=[django.core.validators.MinValueValidator(0)])),
                ('quantity_time', models.PositiveIntegerField(default=0, help_text='The required time in s to apply the skill for one unit of the skill specific quantity.', validators=[django.core.validators.MinValueValidator(0)])),
                ('quantity_co2', models.PositiveIntegerField(default=0, help_text='The required CO2-e to use the skill for one unit of the skill specific quantity. Including required consumables.', validators=[django.core.validators.MinValueValidator(0)])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_description', models.CharField(help_text='Description of the skill quantity (e.g. painting of 1 mm^2. Using the quantity, we calculate the costs and CO2-e. For example to paint 4 mm^2 the costs are 4*quantity_costs of the resource in €).', max_length=254)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('quantity', models.PositiveIntegerField(default=0, help_text='The required quantity of the consumable to apply the skill.', validators=[django.core.validators.MinValueValidator(0)])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_quantity', models.PositiveIntegerField(default=0, help_text='The required quantity of the skill to manufacture the part.', validators=[django.core.validators.MinValueValidator(0)])),
                ('manufacturing_possibility', models.PositiveIntegerField(default=1, help_text='The number of the manufacturing possibility the skill belongs to.', validators=[django.core.validators.MinValueValidator(0)])),
                ('manufacturing_sequence_number', models.PositiveIntegerField(default=1, help_text='The number of the manufacturing sequence the skill belongs to. Starting from 1.', validators=[django.core.validators.MinValueValidator(0)])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
