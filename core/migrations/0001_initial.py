    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fixed_price', models.DecimalField(decimal_places=3, default=0, help_text='The fixed costs in € to use the skill.', max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('fixed_time', models.DecimalField(decimal_places=3, default=0, help_text='The fixed time in s to use the skill (e.g. initial machine preparation).', max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('fixed_co2', models.DecimalField(decimal_places=3, default=0, help_text='The fixed CO2-e to use the skill.', max_digits=10)),
                ('variable_price', models.DecimalField(decimal_places=3, default=0, help_text='The variable costs in € to use the skill.', max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('variable_time', models.DecimalField(decimal_places=3, default=0, help_text='The variable time in s to use the skill.', max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('variable_co2', models.DecimalField(decimal_places=3, default=0, help_text='The variable CO2-e to use the skill.', max_digits=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.DecimalField(decimal_places=3, default=0, help_text='The quantity required in the consumable unit to use the skill for one unit.', max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('fixed_price', models.DecimalField(decimal_places=3, default=0, help_text='The fixed costs in € for this consumable.', max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('fixed_co2', models.DecimalField(decimal_places=3, default=0, help_text='The fixed CO2-e for this consumable.', max_digits=10)),
                ('variable_price', models.DecimalField(decimal_places=3, default=0, help_text='The variable costs in € for one unit of this consumable.', max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('variable_co2', models.DecimalField(decimal_places=3, default=0, help_text='The variable CO2-e for one unit of this consumable.', max_digits=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_quantity', models.DecimalField(decimal_places=3, default=0, help_text='The required quantity of this process step to manufacture the part.', max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
