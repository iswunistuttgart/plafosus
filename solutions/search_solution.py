...
def find_matching_resources(instance) -> dict:
    """
    Find matching resources for each manufacturing step of every manufacturing possibility.

    :param instance: The part instance.

    return: Dictionary containing all possible manufacturing possibilities and the according part manufacturing steps
    ...
    try:
        ...
        for part_manufacturing_process_step in instance.PartManufacturingProcessStep.all():
            try:
                ...
                logger.error("Something unexpected went wrong while analyzing manufacturing process step '{0}' "
                             "of part '{1}'.".format(str(part_manufacturing_process_step), str(instance.pk)),
                             exc_info=True)
...
def calculate_costs_of_permutations(instance,
    ...
    :param instance: The part instance.
    :param manufacturing_possibilities: Dictionary containing all possible manufacturing possibilities and the according part manufacturing steps
    with the possible resource skills.
